...
//
// Modified to replace custom logging methods with Log.* statements. (2016-08)
...
public class BleConnectionCompat {
    private static final String TAG = BleConnectionCompat.class.getCanonicalName();
